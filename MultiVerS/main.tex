...
\begin{frame}
    ...
    \vspace*{-1em} 
    \begin{mybox}
            Given a claim $c$ and a collection of \textit{candidate abstracts}. \\
        ...
        \onehalfspacing
            ...
            \only<3>{
                \begin{figure}[h]
                    ...
                    \begin{flushleft}
                        \textbf{Rationale Prediction:} The model analyzes each sentence's ending $</s>$ to decide if it justifies the claim, using a binary classification.
                    \end{flushleft}
            \end{figure}
            }
